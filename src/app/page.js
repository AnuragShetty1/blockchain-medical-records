...
export default function Home() {
  ...
  const renderContent = () => {
    ...
    // This is the corrected split-screen layout for unregistered users.
    return (
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="p-8">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Welcome to MediLedger, a new era of medical data management where you are in complete control.
          </p>
  ...
  const WelcomeMessage = () => (
    <div className="text-center bg-white p-8 rounded-lg shadow-md">
      ...
      <p className="mt-4 text-gray-600">Please connect your wallet to begin the registration process.</p>
    </div>
  );
